...
class TestRenderSummaryMarkdown:
    ...
    def test_render_links(self):
        ...
        assert "Code file: [src/cli/logging.go](https://github.com/thought-machine/please/blob/master/src/cli/logging.go)" in md
        assert "Code file with line: [src/cli/logging/logging.go:64](https://github.com/thought-machine/please/blob/master/src/cli/logging/logging.go#L64)" in md
        assert "Code file with multiple lines: [tools/build_langserver/langserver_main.go:43-54](https://github.com/thought-machine/please/blob/master/tools/build_langserver/langserver_main.go#L43-54)" in md
